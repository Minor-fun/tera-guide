...
module.exports = (dispatch, handlers, guide, lang) => {
	...
	dispatch.hook("S_ABNORMALITY_BEGIN", dispatch._mod.majorPatchVersion >= 107 ? 5 : 4, event => {
		if (event.id === 32051007) {
			if (dispatch._mod.game.me.is(event.target)) {
				handlers.text({ speech: false, sub_type: "notification", message: t("Lasers on you") });
			} else {
	...
	return {
		...
		"h-3105-1000-80": [{ type: "text", sub_type: "message", message: t("80%") }],
		"h-3105-1000-35": [{ type: "text", sub_type: "message", message: t("35%") }],

		"s-3105-1000-101-0": [{ type: "text", sub_type: "message", message: t("Front Swing") }],
		"s-3105-1000-102-0": [
		...
		"s-3105-1000-106-0": [{ type: "text", sub_type: "message", message: t("Blades Front") }],
		"s-3105-1000-112-0": [
		...
		"s-3105-1000-119-0": [{ type: "text", sub_type: "message", message: t("Cut") }],
		"s-3105-1000-120-0": [{ type: "text", sub_type: "message", message: t("Storm") }],
		"s-3105-1000-107-0": [
			{ type: "text", sub_type: "message", message: t("Spin | Back Laser") },
			{ type: "spawn", func: "circle", args: [true, 553, 0, 0, 12, 290, 100, 5000] }
		],
		"s-3105-1000-117-0": [{ type: "text", sub_type: "message", message: t("Kick") }],
		"s-3105-1000-118-0": [{ type: "text", sub_type: "message", message: t("Kick (Dodge)") }],
		...
		"qb-3105-1000-31051002": [{ type: "text", sub_type: "message", message: t("Shield!") }], // <50%
		"qb-3105-1000-32051002": "qb-3105-1000-31051002",
		"s-3105-1000-123-0": [{ type: "text", sub_type: "message", message: t("Break Failure") }],

		"qb-3105-1000-31051004": [{ type: "text", sub_type: "message", message: t("Bait (Lasers)") }], // range check
		"qb-3105-1000-32051004": "qb-3105-1000-31051004",
		"qb-3105-1000-31051005": [{ type: "text", sub_type: "message", message: t("Bait") }], // get stun
		"qb-3105-1000-32051005": "qb-3105-1000-31051005",
		"qb-3105-1000-31051006": [{ type: "text", sub_type: "message", message: t("Bait") }], // cast ress
		"qb-3105-1000-32051006": "qb-3105-1000-31051006",
		"qb-3105-1000-31051007": [{ type: "text", sub_type: "message", message: t("Puddles") }], // <40%
		...
		"s-3105-1000-121-0": [{ type: "text", sub_type: "message", message: t("AoE") }], // red
		"s-3105-1000-122-0": [{ type: "text", sub_type: "message", message: t("AoE") }], // blue
