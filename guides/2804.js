...
module.exports = (dispatch, handlers, guide, lang) => {
	...
	function waves_event() {
		handlers.event([
			...
			{ type: "text", sub_type: "alert", delay: 60000, message: "Waves soon...", message_RU: "Скоро волны...", message_zh: "即将半月..." }
		]);
	}
	...
	function boss_backattack_event_new(curr, ent) {
		...
		if (curr == 1103 || curr == 1106) {
			...
			const markers = [
				[
					{ type: "text", sub_type: "message", message: "Left", message_RU: "Левый", message_zh: "左" },
				...
				[
					{ type: "text", sub_type: "message", message: "Right", message_RU: "Правый", message_zh: "右" },
	...
	function ninth_new_swipe_event(curr, ent) {
		...
		if (ninth_triple_swipe_remaining > 0) {
			...
			if (curr == 1407) {
				handlers.event([
					{ type: "text", sub_type: "message", message: "Left (Double)", message_RU: "Левый (Двойной)", message_zh: "左 (双挥)" },
					{ type: "spawn", func: "marker", args: [false, 300, 100, 0, 1000, true, null] },
					{ type: "spawn", func: "vector", args: [553, 358, 0, 180, 1100, 100, 2500] },
					{ type: "spawn", func: "vector", args: [553, 358, 0, 0, 1100, 100, 2500] },
				...
				handlers.event([
					{ type: "text", sub_type: "message", message: "Right (Double)", message_RU: "Правый (Двойной)", message_zh: "右 (双挥)" },
					{ type: "spawn", func: "marker", args: [false, 60, 100, 0, 1000, true, null] },
					{ type: "spawn", func: "vector", args: [553, 358, 0, 180, 1100, 100, 2500] },
					{ type: "spawn", func: "vector", args: [553, 358, 0, 0, 1100, 100, 2500] },
	...
	function boss7_star_event(str, type) {
		...
		handlers.event([
			{ type: "text", sub_type: "message", message: message_en, message_RU: message_ru, message_zh: zh_map[message_en] || message_en },
	...
	function boss7_message_event(id) {
		switch (id) {
			...
			case 703:
				if (!boss7_hp_49) { handlers.text({ sub_type: "notification", message: "Debuffs > Circles > Bombs", message_RU: "", message_zh: "Debuff > 圈 > 炸弹" }); } else { handlers.text({ sub_type: "notification", message: "Debuffs > Bombs > Circles", message_RU: "", message_zh: "Debuff > 炸弹 > 圈" }); }
				break;
			// Lakan is trying to take you on (one-1) at a time.
			case 704:
				if (!boss7_hp_49) { handlers.text({ sub_type: "notification", message: "Circles > Bombs > Debuffs", message_RU: "", message_zh: "圈 > 炸弹 > Debuff" }); } else { handlers.text({ sub_type: "notification", message: "Circles > Debuffs > Bombs", message_RU: "", message_zh: "圈 > Debuff > 炸弹" }); }
				break;
			// Lakan intends to kill all of you at once.
			case 705:
				if (!boss7_hp_49) { handlers.text({ sub_type: "notification", message: "Bombs > Debuffs > Circles", message_RU: "", message_zh: "炸弹 > Debuff > 圈" }); } else { handlers.text({ sub_type: "notification", message: "Bombs > Circles > Debuffs", message_RU: "", message_zh: "炸弹 > 圈 > Debuff" }); }
				break;
		}
	}
	...
	function enhanced_text(sub_type, message, delay, ent) {
		...
		handlers.text({
			...
			message_zh: messages_ZH[message] || message,
			delay
		});
	}
	...
	return {
		...
		"s-2804-1000-212-0": [{ type: "text", sub_type: "message", message: "Flash", message_RU: "Байт", message_zh: "闪现" }],
		...
		"s-2804-2000-185-0": [
			{ type: "text", sub_type: "message", message: "Big jump (Kaia's Shield)", message_RU: "Прыжок (кайа)", class_position: "priest", message_zh: "大跳 (套盾)" },
			{ type: "text", sub_type: "message", message: "Big jump (Thrall of Protection)", message_RU: "Прыжок (кайа)", class_position: "mystic", message_zh: "大跳 (套盾)" },
		...
		"s-2804-2000-322-0": [{ type: "text", sub_type: "message", message: "Flash (bleed)", message_RU: "Байт (Кровоток)", message_zh: "闪现 (流血)" }],
		"s-2804-2000-207-0": [{ type: "text", sub_type: "message", message: "Phantom x5 (bleed)", message_RU: "Прыжки x5 (Кровоток)", message_zh: "幻影 x5 (流血)" }],
		"s-2804-2000-212-0": [{ type: "text", sub_type: "message", message: "Flash (bleed)", message_RU: "Байт (Кровоток)", message_zh: "闪现 (流血)" }],
		...
		"s-2804-3000-108-0": [{ type: "text", class_position: "tank", sub_type: "message", message: "Strike (Slow)", message_RU: "Меч (медленный)", message_zh: "慢砍" }],
		"s-2804-1000-355-0": [{ type: "text", sub_type: "message", message: "Eviscerate", message_RU: "Потрошение", message_zh: "猛砍" }],
		"s-2804-3000-135-0": [{ type: "text", sub_type: "message", message: "Strike (Slow)", message_RU: "Меч (медленный)", message_zh: "慢砍" }],
		"s-2804-3000-111-0": [{ type: "text", sub_type: "message", message: "Stun | Strike", message_RU: "Стан | Меч", message_zh: "眩晕 | 砍" }],
		"s-2804-3000-112-0": [{ type: "text", sub_type: "message", message: "Back Jump | Strike", message_RU: "Прыжок назад | Меч", message_zh: "后跳 | 砍" }],
		// Прыжок
		"s-2804-3000-116-0": [
		...
		"s-2804-3000-141-0": [{ type: "text", sub_type: "message", message: "2x360 | Eviscerate", message_RU: "2 оборота | Потрошение", message_zh: "二连转 | 猛砍" }],
		"s-2804-3000-146-0": [{ type: "text", sub_type: "message", message: "Eviscerate | Strike", message_RU: "Потрошение | Меч", message_zh: "猛砍 | 砍" }],
		...
		"s-2804-3000-151-0": [{ type: "text", sub_type: "message", message: "Back teleport | Strike", message_RU: "Телепорт назад | Меч", message_zh: "后瞬 | 砍" }],
		...
		"s-2804-3000-117-0": [{ type: "text", sub_type: "message", message: "Teleport (Target)", message_RU: "Телепорт (таргет)", message_zh: "瞬移 (点名)" }],
		"s-2804-3000-356-0": [{ type: "text", sub_type: "message", message: "Teleport (Target)", message_RU: "Телепорт (таргет)", message_zh: "瞬移 (点名)" }],
		...
		"s-2804-3000-401-0": [
			{ type: "text", sub_type: "message", message: "30% AOE!", message_RU: "АОЕ", message_zh: "百分之三十 全屏AOE！" },
			{ type: "text", sub_type: "message", delay: 1600, message: "Dodge!", message_RU: "Эвейд!", message_zh: "闪避！" }
		],
		...
		"s-2804-4000-315-0": [{ type: "text", sub_type: "message", message: "Pushback", message_RU: "Откид (кайа)", message_zh: "击退 (套盾)" }],
		...
		"am-2804-280426-28040224": [
			...
			{ type: "event", delay: 80000, args: [
				...
				{ type: "text", check_func: () => boss === 1, sub_type: "message", message: "Debuff reload", message_RU: "Смена дебаффа", message_zh: "Debuff 重置" }
			] }
		],
		"am-2804-6000-28040220": [
			...
			{ type: "event", delay: 80000, args: [
				...
				{ type: "text", check_func: () => boss === 0, sub_type: "message", message: "Debuff reload", message_RU: "Смена дебаффа", message_zh: "Debuff 重置" }
			] }
		],
		...
		"s-2804-6000-232-0": [
			{ type: "text", sub_type: "message", message: "In Safe", message_RU: "К нему", message_zh: "内安全" },
			{ type: "spawn", func: "circle", args: [false, 553, 0, 0, 10, 300, 0, 3000] },
		...
		"s-2804-7000-103-0": [{ type: "text", sub_type: "message", message: "Back + Front", message_RU: "Назад + Вперед", message_zh: "后 + 前" }],
		"s-2804-7000-110-0": [{ type: "text", sub_type: "message", message: "Claw", message_RU: "Коготь", message_zh: "爪击" }],
		"s-2804-7000-110-1": [{ type: "func", func: enhanced_text, args: ["alert", "Dodge", 1100] }],
		"s-2804-7000-113-0": [{ type: "text", sub_type: "message", message: "Bait", message_RU: "Байт", message_zh: "假动作" }],
		"s-2804-7000-135-0": [{ type: "text", sub_type: "message", message: "In", message_RU: "К нему", message_zh: "内" }],
		"s-2804-7000-136-0": [{ type: "text", sub_type: "message", message: "Claw", message_RU: "Коготь", message_zh: "爪击" }],
		...
		"s-2804-7000-144-0": [{ type: "text", sub_type: "message", message: "Out", message_RU: "От него", message_zh: "外" }],
		"s-2804-7000-145-0": [{ type: "text", sub_type: "message", message: "In", message_RU: "К нему", message_zh: "内" }],
		"s-2804-7000-151-0": [
			{ type: "text", sub_type: "message", message: "Attention Stun", message_RU: "Внимание: Стан", message_zh: "注视眩晕" },
			{ type: "spawn", func: "circle", args: [false, 912, 0, 100, 18, 210, 0, 3000] }
		],
		"s-2804-7000-152-0": [
			{ type: "text", sub_type: "message", message: "Stun + Back", message_RU: "Стан + Назад", message_zh: "眩晕 + 后" },
			{ type: "spawn", func: "circle", args: [false, 912, 0, 100, 18, 210, 0, 3000] }
		],
		"s-2804-7000-154-0": [{ type: "text", sub_type: "message", message: "Out > In", message_RU: "От него > К нему", message_zh: "外 > 内" }],
		"s-2804-7000-155-0": [{ type: "text", sub_type: "message", message: "In > Out", message_RU: "К нему > От него", message_zh: "内 > 外" }],
		"s-2804-7000-240-0": [
			{ type: "text", sub_type: "message", message: "Donuts (Out > In > Out)", message_RU: "Бублики (От него > К нему > От него)", message_zh: "甜甜圈 (外 > 内 > 外)" },
		...
		"s-2804-7000-301-0": [{ type: "text", sub_type: "message", message: "(Bombs) Gather + Cleanse", message_RU: "(Бомбы) Собраться + Очистка", message_zh: "(炸弹) 集合 + 解毒" }],
		"s-2804-7000-302-0": [{ type: "text", sub_type: "message", message: "(Bombs) Gather + No cleanse", message_RU: "(Бомбы) Собраться + Без очистки", message_zh: "(炸弹) 集合 + 不解毒" }],
		"s-2804-7000-401-0": [
			{ type: "text", sub_type: "message", message: "Inward wave", message_RU: "Волна внутрь", message_zh: "内圈波" },
			{ type: "text", sub_type: "message", message: "Plague of Exhaustion", message_RU: "Чума истощения", class_position: "priest", delay: 1000, message_zh: "瘟疫" },
			{ type: "text", sub_type: "message", message: "Regression", message_RU: "Регресс", class_position: "mystic", delay: 1000, message_zh: "回归" },
			{ type: "spawn", func: "circle", args: [false, 912, 0, 0, 16, 175, 2000, 5000] }
		],
		"s-2804-7000-402-0": [
			{ type: "text", sub_type: "message", message: "Inward wave", message_RU: "Волна внутрь", message_zh: "内圈波" },
			{ type: "text", sub_type: "message", message: "Sleep Boss", message_RU: "Усыпить босса", class_position: "heal", delay: 1000, message_zh: "睡王" },
			{ type: "spawn", func: "circle", args: [false, 912, 0, 0, 16, 175, 2000, 5000] }
		],
		...
		"s-2804-8000-112-0": [{ type: "text", sub_type: "message", message: "Back Move", message_RU: "Рывок назад", message_zh: "后退" }],
		...
		"s-2804-8000-115-0": [
			{ type: "text", sub_type: "message", message: "3", message_RU: "3", message_zh: "3" },
			{ type: "text", sub_type: "message", delay: 1000, message: "2", message_RU: "2", message_zh: "2" },
			{ type: "text", sub_type: "message", delay: 2000, message: "1", message_RU: "1", message_zh: "1" },
			{ type: "text", sub_type: "message", delay: 3200, message: "Dodge", message_RU: "Эвейд", message_zh: "闪避" }
		],
		"s-2804-8000-117-0": [{ type: "text", sub_type: "message", message: "Front", message_RU: "Удар вперед", message_zh: "前方" }],
		"s-2804-8000-302-0": [
			{ type: "text", sub_type: "message", message: "AOE", message_RU: "АоЕ", message_zh: "全屏AOE" },
		...
		"s-2804-8000-303-0": [{ type: "text", sub_type: "message", message: "Spin Attack", message_RU: "Крутилка", message_zh: "旋转攻击" }],
		...
		"s-2804-8000-301-0": [{ type: "text", sub_type: "message", message: "Scream", message_RU: "Вопль", message_zh: "尖叫" }],
		"s-2804-8000-312-0": [{ type: "text", sub_type: "message", message: "Ghost", message_RU: "Дух", message_zh: "幽灵" }],
		...
		"s-2804-9000-121-0": [
			{ type: "text", sub_type: "message", message: "Waves (Left)", message_RU: "Волны (левая)", message_zh: "半月 (左)" },
		...
		"s-2804-9000-122-0": [
			{ type: "text", sub_type: "message", message: "Waves (Left) 3nd fast", message_RU: "Волны (левая) 3-я быстрая", message_zh: "半月 (左) 第三波快" },
			{ type: "func", func: waves_event },
			{ type: "spawn", func: "marker", args: [false, 37, 125, 0, 2533, false, ["safe", "safe", "安全"]] },
			{ type: "spawn", func: "marker", args: [false, 143, 125, 0, 2533, false, ["safe", "safe", "安全"]] }
		],
		"s-2804-9000-123-0": [
			{ type: "text", sub_type: "message", message: "Waves (Left) 2nd fast", message_RU: "Волны (левая) 2-я быстрая", message_zh: "半月 (左) 第二波快" },
			{ type: "func", func: waves_event },
		...
		"s-2804-9000-140-0": [
			{ type: "text", sub_type: "message", message: "Waves (Right)", message_RU: "Волны (правая)", message_zh: "半月 (右)" },
			{ type: "func", func: waves_event },
		...
		"s-2804-9000-141-0": [
			{ type: "text", sub_type: "message", message: "Waves (Right) 3nd fast", message_RU: "Волны (правая) 3-я быстрая", message_zh: "半月 (右) 第三波快" },
			{ type: "func", func: waves_event },
			{ type: "spawn", func: "marker", args: [false, 323, 125, 0, 2533, false, ["safe", "safe", "安全"]] },
			{ type: "spawn", func: "marker", args: [false, 217, 125, 0, 2533, false, ["safe", "safe", "安全"]] }
		],
		"s-2804-9000-142-0": [
			{ type: "text", sub_type: "message", message: "Waves (Right) 2nd fast", message_RU: "Волны (правая) 2-я быстрая", message_zh: "半月 (右) 第二波快" },
			{ type: "func", func: waves_event },
		...
		"s-2804-9000-307-0": [
			...
			{ type: "text", sub_type: "message", delay: 20000, message: "Last aerolite", message_RU: "Последний метеор", message_zh: "陨石" }
		],
		...
		"s-2804-9000-311-0": [
			{ type: "text", sub_type: "message", message: "Wrath (Kaia)", message_RU: "Облепиха (кайа)", message_zh: "愤怒 (套盾)" },
		...
		*/
		...
		"h-2804-10000-40": [{ type: "text", sub_type: "message", message: "40%", message_zh: "百分之四十" }],
		"h-2804-10000-50": [{ type: "text", sub_type: "message", message: "50%", message_zh: "百分之五十" }],
		"h-2804-10000-80": [{ type: "text", sub_type: "message", message: "80%", message_zh: "百分之八十" }],
		// Donuts
