...
module.exports = (dispatch, handlers, guide, lang) => {
	...
	return {
		...
		"s-781-1000-1111-0": [{ type: "text", sub_type: "message", message: "Back 360", message_RU: "Задняя 360", message_zh: "背后三百六十度" }],
		"s-781-1000-1401-0": [
		...
		"s-781-1000-1303-0": [{ type: "text", sub_type: "message", message: "Spin", message_RU: "Крутилка", message_zh: "翻滚" }],
		"s-781-1000-1304-0": [
		...
		"s-781-1000-1308-0": [{ type: "text", sub_type: "message", message: "OUT", message_RU: "Наружу", message_zh: "远离" }],
		"s-781-1000-1309-0": [{ type: "text", sub_type: "message", message: "IN", message_RU: "Внутрь", message_zh: "靠近" }],
		"s-781-1000-1112-0": [{ type: "text", sub_type: "message", message_RU: "Рывок назад", message_zh: "向后冲刺", message: "Back Move" }],
		"s-781-1000-1113-0": [{ type: "text", sub_type: "message", message: "Front + AoEs", message_RU: "Передняя + AOE", message_zh: "前方加范围攻击" }],
		"s-781-1000-1114-0": [
		...
		"s-781-1000-1115-0": [{ type: "text", sub_type: "message", delay: 3200, message_RU: "Эвейд", message_zh: "闪避", message: "Dodge" }], // dodge circle
		"s-781-1000-1117-0": [{ type: "text", sub_type: "message", delay: 5200, message_RU: "Эвейд", message_zh: "闪避", message: "Dodge" }], // dodge circles
		...
		"qb-781-1000-98103": [{ type: "text", sub_type: "message", message: "Lead circle to the stone", message_RU: "Отвести круг к пилону", message_zh: "带圈去石柱" }],
		"qb-781-1000-78107": [{ type: "text", sub_type: "message", message: "Lead circles to the stone", message_RU: "Отвести круги к пилону", message_zh: "带圈去石柱" }],
		...
		"s-781-2000-1108-0": [{ type: "text", sub_type: "message", message: "Front", message_RU: "Передний", message_zh: "前方攻击" }],
		"s-781-2000-1110-0": [{ type: "text", sub_type: "message", message: "Back Move", message_RU: "Рыыок назад", message_zh: "向后冲刺" }],
		"s-781-2000-1111-0": [{ type: "text", sub_type: "message", message: "360 attack", message_RU: "Круговая", message_zh: "旋转攻击" }],
		"s-781-2000-1114-0": [{ type: "text", sub_type: "message", message: "Pull", message_RU: "Притяжка", message_zh: "拉人" }],
		"s-781-2000-1115-0": [{ type: "text", sub_type: "message", message: "Circles", message_RU: "Круги", message_zh: "圆圈" }],
		"s-781-2000-1115-1": [{ type: "text", sub_type: "message", message: "Dodge", message_RU: "Эвейд", message_zh: "闪避", delay: 150 }],
		"s-781-2000-1117-0": [{ type: "text", sub_type: "message", message: "Jump", message_RU: "Прыжок", message_zh: "跳跃" }],
		"s-781-2000-1130-0": [
			{ type: "text", sub_type: "message", message: "Left", message_RU: "Откид влево", message_zh: "向左击退" },
			{ type: "spawn", func: "vector", args: [553, 360, 400, 180, 800, 0, 2000] },
			{ type: "spawn", func: "marker", args: [false, 60, 100, 0, 2000, true, null] },
		...
		"s-781-2000-1136-0": [{ type: "text", sub_type: "message", message: "Donut", message_RU: "Бублик", message_zh: "环形攻击" }],
		"s-781-2000-1202-0": [{ type: "text", sub_type: "message", message: "Target Throw", message_RU: "Бросок цели", message_zh: "投掷目标" }],
		"s-781-2000-1205-0": [{ type: "text", sub_type: "message", message: "Target Throw", message_RU: "Бросок цели", message_zh: "投掷目标" }],
		"s-781-2000-1206-0": [{ type: "text", sub_type: "message", message: "Pike (Target)", message_RU: "Копье (таргет)", message_zh: "点名长矛" }],
		"s-781-2000-1302-0": [{ type: "text", sub_type: "message", message: "Bait (Target)", message_RU: "Байт (таргет)", message_zh: "诱导点名" }],
		"s-781-2000-1302-1": [{ type: "text", sub_type: "message", message: "Dodge", message_RU: "Эвейд", message_zh: "闪避", delay: 1600 }],
		"s-781-2000-1502-0": [
			{ type: "text", sub_type: "message", message: "AoE", message_RU: "АоЕ", message_zh: "范围攻击" },
			{ type: "spawn", func: "circle", args: [true, 553, 0, 80, 8, 390, 0, 3000] }
		],
		"s-781-2000-1503-0": [{ type: "text", sub_type: "message", message: "Target Lockon", message_RU: "Захват цели", message_zh: "锁定目标" }],
		"s-781-2000-1504-0": [{ type: "text", sub_type: "message", message: "Mobs Summon", message_RU: "Призыв мобов", message_zh: "召唤小怪" }],
		//
		...
		//
		"qb-781-4000-9781046": [{ type: "text", sub_type: "notification", message: "First: (Debuffs) Closest", message_RU: "[ДКБ] Первая: дебафф (ближние)", message_zh: "第一轮debuff最近的" }], // Thank you... for this release...
		"qb-781-4000-9781047": [{ type: "text", sub_type: "notification", message: "First: (Circles) Spread", message_RU: "[КБД] Первая: круги (отдельно)", message_zh: "第一轮圈散开" }], // Beware the... red lightning...
		"qb-781-4000-9781048": [{ type: "text", sub_type: "notification", message: "First: (Bombs) Gather + Cleanse", message_RU: "[БДК] Первая: бомбы (вместе + клинс)", message_zh: "第一轮炸弹集合净化" }], // Beware the mark... of Lakan...
		...
		"s-781-3000-1404-0": [{ type: "text", sub_type: "message", message: "(Debuffs) Closest", message_RU: "Дебафф (ближние)", message_zh: "debuff点最近的" }],
		"s-781-3000-1405-0": [{ type: "text", sub_type: "message", message: "(Debuffs) Farthest", message_RU: "Дебафф (дальние)", message_zh: "debuff点最远的" }],
		"s-781-3000-1301-0": [{ type: "text", sub_type: "message", message: "(Bombs) Gather + Cleanse", message_RU: "Бомбы (вместе!) + клинс", message_zh: "炸弹集合加净化" }],
		"s-781-3000-1302-0": [{ type: "text", sub_type: "message", message: "(Bombs) Gather + No cleanse", message_RU: "Бомбы (вместе!) + без клинса", message_zh: "炸弹集合不净化" }],
		"s-781-3000-3103-0": [{ type: "text", sub_type: "message", message: "(Circles) Spread", message_RU: "Круги (отдельно!)", message_zh: "圈散开" }],
		"s-781-3000-3105-0": [{ type: "text", sub_type: "message", message: "(Circles) Gather", message_RU: "Круги (вместе!)", message_zh: "圈集合" }],
		"s-781-3000-1136-0": [{ type: "text", sub_type: "message", message: "Claw", message_RU: "Когти", message_zh: "爪击" }],
		"s-781-3000-1136-1": [{ type: "text", sub_type: "message", message: "Dodge", message_RU: "Эвейд", message_zh: "闪避", delay: 1000 }],
		"s-781-3000-1144-0": [{ type: "text", sub_type: "message", message: "OUT", message_RU: "Наружу", message_zh: "远离" }],
		"s-781-3000-1145-0": [{ type: "text", sub_type: "message", message: "IN", message_RU: "Внутрь", message_zh: "靠近" }],
		"s-781-3000-1240-0": [
		...
		"s-781-3000-1402-0": [{ type: "text", sub_type: "message", message: "Sleep", message_RU: "Слип!!", message_zh: "睡眠！" }],
		"s-781-3000-1701-0": [{ type: "text", sub_type: "message", message: "Back + Front", message_RU: "Назад + Вперед", message_zh: "后加前" }],
		//
		"s-781-3000-1113-0": [{ type: "text", sub_type: "message", message: "Bait", message_RU: "Байт", message_zh: "诱导" }],
		"s-781-3000-1151-0": [{ type: "text", sub_type: "message", message: "Attention Stun", message_RU: "Стан", message_zh: "注意击晕" }],
		"s-781-3000-1152-0": [{ type: "text", sub_type: "message", message: "Stun + Back", message_RU: "Стан + Откид назад", message_zh: "眩晕加背后击退" }],
		"s-781-3000-1152-1": [{ type: "text", sub_type: "message", message: "Dodge", message_RU: "Эвейд", message_zh: "闪避", delay: 1900 }],
