...
module.exports = (dispatch, handlers, guide, lang, t) => {
	...
	return {
		...
		"ns-983-1008": [{ type: "text", sub_type: "message", message: t("Take Balls") }],
		"s-983-1000-101-0": [
			{ type: "text", sub_type: "message", message: t("Stun"), check_func: () => firstboss_prepare_stun },
		...
		"s-983-1000-104-0": [{ type: "text", sub_type: "message", message: t("Jump") }],
		"s-983-1000-109-0": [{ type: "text", sub_type: "message", message: t("Push Back") }],
		"s-983-1000-119-0": [
			{ type: "text", sub_type: "message", message: t("Heavy") },
			{ type: "text", sub_type: "message", message: t("Dodge"), delay: 250 },
			{ type: "spawn", func: "circle", args: [true, 553, 0, 50, null, 350, 0, 3000] }
		],
		"s-983-1000-127-0": [{ type: "text", sub_type: "message", message: t("Many Attack") }],
		"s-983-1000-128-0": [{ type: "text", sub_type: "message", message: t("Lazer") }],
		"s-983-1000-130-0": "s-983-1000-128-0",
		"s-983-1000-301-0": [{ type: "text", sub_type: "message", message: t("Dodge"), delay: 1900 }],
		"s-983-1000-304-0": [{ type: "text", sub_type: "message", message: t("Pull (Take circles away from the boss)") }],
		"s-983-1000-305-0": [{ type: "text", sub_type: "message", message: t("Triple Laser (Together)") }],
		...
		"s-983-2000-105-0": [{ type: "text", sub_type: "message", message: t("Whip (Dodge)") }],
		"s-983-2000-110-0": [{ type: "text", sub_type: "message", message: t("Front Attack (Dodge)") }],
		"s-983-2000-112-0": [{ type: "text", sub_type: "message", message: t("Push Back (Right)") }],
		"s-983-2000-114-0": [{ type: "text", sub_type: "message", message: t("Ground Hit (Dodge)") }],
		"s-983-2000-115-0": [{ type: "text", sub_type: "message", message: t("Push Back (Left)") }],
		"s-983-2000-119-0": [{ type: "text", sub_type: "message", message: t("Jump (Dodge)") }],
		"s-983-2000-120-0": [{ type: "text", sub_type: "message", message: t("Front Attack | Push Back") }],
		"s-983-2000-206-0": [{ type: "func", func: ent => secondboss_game_id_for_book = ent.gameId }], // prepare to take the book
		"s-983-2000-316-0": [{ type: "text", sub_type: "message", message: t("Fire AOE") }],
		"s-983-2000-306-0": [
			{ type: "text", sub_type: "message", message: t("Dodge | Out") },
			{ type: "spawn", func: "circle", args: [true, 553, 0, -50, null, 375, 0, 5000] }
		],
		"s-983-2000-317-0": [{ type: "text", sub_type: "message", message: t("Water AOE") }],
		"s-983-2000-318-0": [
			{ type: "text", sub_type: "message", message: t("Dodge (Get out)") },
			{ type: "spawn", func: "circle", args: [true, 553, 0, -50, null, 700, 0, 7000] }
		],
		"s-983-2000-324-0": [{ type: "text", sub_type: "message", message: t("Dodge (Pull)"), delay: 2400 }],
		//
		...
		"s-983-3000-106-0": [{ type: "text", sub_type: "message", message: t("Push (Tank)") }],
		"s-983-3000-110-0": [{ type: "text", sub_type: "message", message: t("Throw Front (Stun)") }],
		"s-983-3000-113-0": [{ type: "text", sub_type: "message", message: t("Push Back") }],
		"s-983-3000-114-0": [{ type: "text", sub_type: "message", message: t("Bait (Target)") }],
		...
		"s-983-3000-124-0": [{ type: "text", sub_type: "message", message: t("AoE (Dodge)") }],
		"s-983-3000-126-0": [
			{ type: "text", sub_type: "message", message: t("Frontal Stun | Back Hit") },
		...
		"s-983-3000-129-0": [{ type: "text", sub_type: "message", message: t("Somersault | Back Hit") }],
		"s-983-3000-130-0": [
			{ type: "text", sub_type: "message", message: t("Back Hit (Bleed)") },
			{ type: "spawn", func: "circle", args: [true, 553, 180, 340, null, 250, 0, 2000] }
		],
		"s-983-3000-142-0": [{ type: "text", sub_type: "message", message: t("Frontal Combo") }],
		"s-983-3000-301-0": [
		...
		"s-983-3000-309-0": [
			...
			{ type: "text", sub_type: "message", message: t("Lasers"), delay: 3000 }
		],
		"s-983-3000-315-0": [
			{ type: "text", sub_type: "message", message: t("Dodge | Out") },
