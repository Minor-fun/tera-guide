...
module.exports = (dispatch, handlers, guide, lang) => {
	...
	return {
		...
		"s-3106-1000-105-0": [{ type: "text", sub_type: "message", message: t("Knockback Spin (Kaia)"), check_func: () => combo_start === true }],
		"s-3106-1000-106-0": [
		...
		"s-3106-1000-111-0": [{ type: "text", sub_type: "message", message: t("Knockdown (Dodge)"), class_position: "tank" }],
		"s-3106-1000-201-0": [{ type: "text", sub_type: "message", message: t("Front (Dodge)"), class_position: "tank" }],
		"s-3106-1000-202-0": [{ type: "text", sub_type: "message", message: t("Front AoE") }],
		"s-3106-1000-203-0": [{ type: "text", sub_type: "message", message: t("Front AoE + Wave") }],
		"s-3106-1000-205-0": [{ type: "text", sub_type: "message", message: t("Spin") }],
		"s-3106-1000-206-0": [{ type: "text", sub_type: "message", message: t("Spin (Bleed)") }],
		"s-3106-1000-207-0": [{ type: "text", sub_type: "message", message: t("Spin (Bleed)") }],
		"s-3106-1000-209-0": [
		...
		"s-3106-1000-211-0": [{ type: "text", sub_type: "message", message: t("Push") }],
		"s-3106-1000-212-0": [{ type: "text", sub_type: "message", message: t("Somersault") }],
		"s-3106-1000-215-0": [{ type: "text", sub_type: "message", message: t("Somersault") }],
		"s-3106-1000-507-0": [{ type: "text", sub_type: "message", message: t("Leash | Jump (Knockdown)") }],
		"s-3106-1000-508-0": [
		...
		"s-3106-1000-512-0": [{ type: "text", sub_type: "message", message: t("Turn | Spin") }],
		//"s-3106-1000-513-0": [{ type: "text", sub_type: "message", message: t("Plague/Regress") }],
		//"s-3106-1000-514-0": [{ type: "text", sub_type: "message", message: t("Plague/Regress") }],

		"s-3106-1000-502-0": [{ type: "text", sub_type: "message", message: t("Unleash") }],
		"s-3106-1000-518-0": [{ type: "text", sub_type: "message", message: t("Unleash") }],
		"s-3106-1000-519-0": [{ type: "text", sub_type: "message", message: t("Unleash") }],
		"s-3106-1000-306-0": [{ type: "text", sub_type: "message", message: t("Spin") }],
		"s-3106-1000-309-0": [{ type: "text", sub_type: "message", message: t("Front") }],
		"s-3106-1000-311-0": [{ type: "text", sub_type: "message", message: t("Evade!"), delay: 150 }],
		"s-3106-1000-321-0": [{ type: "text", sub_type: "message", message: t("AoE") }],
		"s-3106-1000-324-0": [{ type: "text", sub_type: "message", message: t("AoE") }]
	};
};