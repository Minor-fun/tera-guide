...
module.exports = (dispatch, handlers, guide, lang) => {
	...
	return {
		...
		"s-3202-1000-1107-0": [{ type: "text", sub_type: "message", message: "Spectral Throw (Bait)", message_RU: "Спектральный бросок (байт)", message_zh: "诱导幽灵投掷" },
			{ type: "text", sub_type: "message", delay: 1400, message: "Dodge!", message_RU: "Эвейд!", message_zh: "闪避！" }
		],
		"s-3202-1000-2107-0": [{ type: "text", sub_type: "message", message: "Spectral Throw (Bait)", message_RU: "Спектральный бросок (байт)", message_zh: "诱导幽灵投掷" },
			{ type: "text", sub_type: "message", delay: 1400, message: "Dodge!", message_RU: "Эвейд!", message_zh: "闪避！" }
		],
		// Basic attacks
		"s-3202-1000-1103-0": [{ type: "text", sub_type: "message", message: "2 Hits | Bleed", message_RU: "2 удара | Кровоток", message_zh: "二连击带流血" }],
		"s-3202-1000-2103-0": [{ type: "text", sub_type: "message", message: "2 Hits | Bleed", message_RU: "2 удара | Кровоток", message_zh: "二连击带流血" }],
		"s-3202-1000-1113-0": [{ type: "text", sub_type: "message", message: "4 Hits Combo", message_RU: "4 удара комба", message_zh: "四连击" }],
		"s-3202-1000-2113-0": [{ type: "text", sub_type: "message", message: "4 Hits Combo", message_RU: "4 удара комба", message_zh: "四连击" }],
		"s-3202-1000-1105-0": [{ type: "text", sub_type: "message", message: "Uppercut | Stun", message_RU: "Удар снизу | Стан", message_zh: "上勾拳接眩晕" }],
		"s-3202-1000-2105-0": [{ type: "text", sub_type: "message", message: "Uppercut | Stun", message_RU: "Удар снизу | Стан", message_zh: "上勾拳接眩晕" }],
		"s-3202-1000-1106-0": [{ type: "text", sub_type: "message", message: "Stun", message_RU: "Стан", message_zh: "晕" }],
		"s-3202-1000-2106-0": [{ type: "text", sub_type: "message", message: "Stun", message_RU: "Стан", message_zh: "晕" }],
		// 120 > 114
		"s-3202-1000-1120-0": [
		...
		"s-3202-1000-1111-0": [{ type: "text", sub_type: "message", message: "Leap (Stun)", message_RU: "Прыжок (стан)", message_zh: "跳跃眩晕" },
			{ type: "text", sub_type: "message", delay: 1800, message: "Dodge!", message_RU: "Эвейд!", message_zh: "闪避！" }
		],
		"s-3202-1000-2111-0": [{ type: "text", sub_type: "message", message: "Leap (Stun)", message_RU: "Прыжок (стан)", message_zh: "跳跃眩晕" },
			{ type: "text", sub_type: "message", delay: 1750, message: "Dodge!", message_RU: "Эвейд!", message_zh: "闪避！" }
		],
		"s-3202-1000-1115-0": [
			{ type: "text", sub_type: "message", message: "AOE Bombs (Spread)", message_RU: "AOE бомбы (разойтись)", message_zh: "范围炸弹散开" },
			{ type: "text", sub_type: "message", delay: 3000, message: "Gather!", message_RU: "Собраться!", message_zh: "集合！" }
		],
		"s-3202-1000-2115-0": [
			{ type: "text", sub_type: "message", message: "AOE Bombs (Spread)", message_RU: "AOE бомбы (разойтись)", message_zh: "范围炸弹散开" },
			{ type: "text", sub_type: "message", delay: 3000, message: "Gather!", message_RU: "Собраться!", message_zh: "集合！" }
		...
		"s-3202-1000-1304-0": [{ type: "text", sub_type: "message", message: "Shield!", message_RU: "ЩИТ!", message_zh: "护盾！" }],
		"s-3202-1000-2304-0": [{ type: "text", sub_type: "message", message: "Shield!", message_RU: "ЩИТ!", message_zh: "护盾！" }],
		...
		"s-3202-1000-1121-0": [
			{ type: "text", sub_type: "message", message: "Pizza | Waves (Out > In)", message_RU: "Пицца | Волны (от него > к нему)", message_zh: "披萨接波出再进" },
		...
		"s-3202-1000-1127-0": [
			{ type: "text", sub_type: "message", message: "Waves (Out > In)", message_RU: "Волны (от него > к нему)", message_zh: "波出再进" },
		...
		"s-3202-1000-1124-0": [
			{ type: "text", sub_type: "message", message: "Pizza | Waves (In > Out)", message_RU: "Пицца | Волны (к нему > от него)", message_zh: "披萨接波进再出" },
			{ type: "spawn", func: "circle", args: [false, 553, 0, 0, 8, 550, 0, 3000] },
			{ type: "spawn", func: "marker", args: [false, 80, 300, 0, 3500, true, null] },
			{ type: "spawn", func: "marker", args: [false, 280, 300, 0, 3500, true, null] },
			{ type: "spawn", func: "vector", args: [912, 0, 50, 60, 450, 0, 3500] },
		...
		"s-3202-1000-1128-0": [
			{ type: "text", sub_type: "message", message: "Waves (In > Out)", message_RU: "Волны (к нему > от него)", message_zh: "波进再出" },
			{ type: "spawn", func: "circle", args: [false, 445, 0, 0, 14, 160, 0, 3000] },
			{ type: "spawn", func: "circle", args: [false, 445, 0, 0, 8, 390, 0, 3000] },
			{ type: "spawn", func: "circle", args: [false, 445, 0, 0, 6, 620, 0, 3000] }
		],
