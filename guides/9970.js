...
module.exports = (dispatch, handlers, guide, lang) => {
	...
	return {
		...
		"s-970-1000-1306-0": [ // red inside
			...
			{ type: "text", sub_type: "alert", message: "OUT", message_RU: "ОТ НЕГО", message_zh: "远离", check_func: () => firstboss_debuff === 1 },
			{ type: "text", sub_type: "alert", message: "IN", message_RU: "К НЕМУ", message_zh: "靠近", check_func: () => firstboss_debuff === 2 },
		...
		"s-970-1000-1307-0": [ // blue inside
			...
			{ type: "text", sub_type: "alert", message: "IN", message_RU: "К НЕМУ", message_zh: "靠近", check_func: () => firstboss_debuff === 1 },
			{ type: "text", sub_type: "alert", message: "OUT", message_RU: "ОТ НЕГО", message_zh: "远离", check_func: () => firstboss_debuff === 2 },
			{ type: "spawn", func: "circle", args: [false, 553, 0, 0, 10, 400, 0, 4000] }
		],
