...
module.exports = (dispatch, handlers, guide, lang, t) => {
		...
		handlers.event([
			{
				type: "text",
				sub_type: "message",
				message: util.format(format, t("Red"), t("Blue"), t("Yellow")),
				speech: false
			},
			{
				type: "text",
				sub_type: "notification",
				message: util.format(format_cc, t("Red"), t("Blue"), t("Yellow")),
				speech: false
			}
		]);
	}
	...
	return {
		...
		"h-3920-3000-64": [{ type: "text", sub_type: "message", message: t("64%") }],
		"h-3920-3000-40": [{ type: "text", sub_type: "message", message: t("40%") }],

		"ab-3920-3000-40004011": [{ type: "func", func: () => buff_merciless = true }], // resonance 31+ effect

		"s-3920-3000-105-0": [{ type: "text", sub_type: "message", message: t("Target Cage") }],
		"s-3920-3000-107-0": [
			{ type: "text", sub_type: "message", message: t("Random Jump") },
			{ type: "text", sub_type: "message", message: t("Spin soon"), check_func: () => buff_merciless, delay: 1000 }
		],
		"s-3920-3000-107-1": [{ type: "spawn", func: "circle", args: [false, 553, 0, 85, 12, 250, 0, 2000] }],
		"s-3920-3000-113-0": [
			{ type: "text", sub_type: "message", message: t("Front | Back Stun") },
		...
		"s-3920-3000-115-0": [{ type: "text", sub_type: "message", message: t("Spin Attack") }],
		"s-3920-3000-131-0": [{ type: "text", sub_type: "message", message: t("Front Knockup") }],
		"s-3920-3000-120-0": [{ type: "text", sub_type: "message", message: t("Energy Beam (Slow)") }],
		"s-3920-3000-122-0": [{ type: "text", sub_type: "message", message: t("Energy Beam (Slow)") }],
		"s-3920-3000-204-0": [{ type: "text", sub_type: "message", message: t("Energy Beam (Fast)") }],
		"s-3920-3000-309-0": [{ type: "text", sub_type: "message", message: t("AoE") }],
		"s-3920-3000-310-0": [{ type: "text", sub_type: "message", message: t("Puddles") }],
		...
		"s-3920-3000-209-0": [
			{ type: "text", sub_type: "message", message: t("Left") },
			{ type: "text", sub_type: "message", message: t("Inward (In > In > Out)"), delay: 1000 },
			{ type: "spawn", func: "vector", args: [553, 0, 0, 180, 500, 0, 1500] },
			{ type: "spawn", func: "vector", args: [553, 0, 0, 0, 500, 0, 1500] },
			{ type: "spawn", func: "semicircle", args: [0, 180, 912, 0, 0, 20, 160, 0, 1500] },
			{ type: "spawn", func: "semicircle", args: [0, 180, 912, 0, 0, 12, 220, 0, 1500] },
		...
		"s-3920-3000-211-0": [
			{ type: "text", sub_type: "message", message: t("Right") },
			{ type: "text", sub_type: "message", message: t("Outward (Out > In > Out)"), delay: 1000 },
			{ type: "spawn", func: "vector", args: [553, 0, 0, 180, 500, 0, 1500] },
			{ type: "spawn", func: "vector", args: [553, 0, 0, 0, 500, 0, 1500] },
			{ type: "spawn", func: "semicircle", args: [180, 360, 912, 0, 0, 20, 160, 0, 1500] },
			{ type: "spawn", func: "semicircle", args: [180, 360, 912, 0, 0, 12, 220, 0, 1500] },
		...
		// Orbs mech
		"s-3920-3000-206-0": [{ type: "text", sub_type: "message", message: t("Orbs") }],

		// Pushback mech
		"ab-3920-3000-31083063-1": [{ type: "text", sub_type: "notification", message: t("Stack 1") }],
		"ab-3920-3000-31083063-2": [{ type: "text", sub_type: "notification", message: t("Stack 2") }],
		...
		// Cage mech
		"qb-3920-3000-31083002": [{ type: "text", sub_type: "message", message: t("Cage") }],
		"s-3920-3000-317-0": [
