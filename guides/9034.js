...
module.exports = (dispatch, handlers, guide, lang, t) => {
	...
	*/
	...
	function curse_mob_spawned(ent) {
		...
		const curse_msg = angle > 0  ? t("Curse Left") : t("Curse Right");
		handlers.text({
			sub_type: "message",
			message: curse_msg
		});
	...
	return {
		...
		"ab-434-1000-90340105": [{ type: "text", sub_type: "message", message: t("STUN IT") }],
		"s-434-1000-1102-0": [{ type: "text", sub_type: "message", message: t("Running") },
		{ type: "func", func: knockback_firstfloor.bind(null) }],
		"s-434-1000-1105-0": [{ type: "text", sub_type: "message", message: t("Breath") }],
		"s-434-1000-1108-0": [{ type: "text", sub_type: "message", message: t("KNOCKBACK") }],
		"s-434-1000-1203-0": [
			{ type: "text", sub_type: "message", message: t("Sleep") },
			{ type: "spawn", func: "circle", args: [false, 553, 0, 0, 0, 250, 0, 3500] },
			{ type: "text", sub_type: "message", delay: 900, message: t("dodge") }],
		"s-434-1000-1304-0": [{ type: "text", sub_type: "message", message: t("Backstep") }],
		...
		"s-434-2000-1102-0": [{ type: "text", sub_type: "message", message: t("SPIN") }],
		"s-434-2000-1106-0": [{ type: "text", sub_type: "message", message: t("EVADE/Front AOE") }],
		"s-434-2000-1107-0": [{ type: "text", sub_type: "message", message: t("BACK") }],
		"s-434-2000-1108-0": [{ type: "text", sub_type: "message", message: t("Front") }],
		"s-434-2000-1109-0": [{ type: "text", sub_type: "message", message: t("Back Spin") }],
		"s-434-2000-1110-0": [
		...
		"s-434-2000-1113-0": [{ type: "text", sub_type: "message", message: t("Back Combo") }],
		"s-434-2000-1119-0": [{ type: "text", sub_type: "message", message: t("PULL") }],
		"s-434-2000-1122-0": [{ type: "text", sub_type: "message", message: t("IN") }],
		"s-434-2000-1306-0": [
			{ type: "text", sub_type: "message", message: t("Stand by head") },
			{ type: "text", sub_type: "message", message: t("4"), delay: 5000 },
			{ type: "text", sub_type: "message", message: t("3"), delay: 6000 },
			{ type: "text", sub_type: "message", message: t("2"), delay: 7000 },
			{ type: "text", sub_type: "message", message: t("1"), delay: 8000 }
		],
		...
		"s-434-3000-1106-0": [{ type: "text", sub_type: "message", message: t("back!") }],
		"s-434-3000-1108-0": [{ type: "text", sub_type: "message", message: t("forward!") }],
		"s-434-3000-1112-0": [{ type: "text", sub_type: "message", message: t("To the Boss") }],
		"s-434-3000-1130-0": [
			{ type: "text", sub_type: "message", message: t("Right") }, // left swipe
			{ type: "spawn", func: "marker", args: [false, 130, 200, 0, 2000, true, null] },
			{ type: "spawn", func: "marker", args: [false, 60, 200, 0, 2000, true, null] }
		],
		"s-434-3000-1131-0": [
			{ type: "text", sub_type: "message", message: t("Left") }, // RIGHT SWIPE
			{ type: "spawn", func: "marker", args: [false, -130, 200, 0, 2000, true, null] },
			{ type: "spawn", func: "marker", args: [false, -60, 200, 0, 2000, true, null] }
		],
		"s-434-3000-1134-0": [{ type: "text", sub_type: "message", message: t("Debuff") }], //
		"s-434-3000-1502-0": [{ type: "text", sub_type: "message", message: t("FORCED CAGE") }], //
		"ns-434-3004": [{ type: "text", sub_type: "message", message: t("Kill mobs") }],
		...
		"s-434-4000-1102-0": [{ type: "text", sub_type: "message", message: t("Out | In") }],
		"s-434-4000-1103-0": [{ type: "text", sub_type: "message", message: t("In | Out") }],
		"s-434-4000-1107-0": [{ type: "text", sub_type: "message", message: t("Under the tank, then under the dd") }],
		"s-434-4000-1108-0": [
		...
		"s-434-4000-1109-1": [{ type: "text", sub_type: "message", message: t("Beam") }],
		"s-434-4000-1109-2": [{ type: "text", sub_type: "message", message: t("dodge") }],
		"s-434-4000-1205-0": [{ type: "text", sub_type: "message", message: t("Laser") }],
		"s-434-4000-1206-0": [{ type: "text", sub_type: "message", message: t("Beam forward, left, right") }],
		"ns-434-4001": [{ type: "text", sub_type: "message", message: t("Kill mobs") }],
		...
		"h-434-5000-85": [{ "type": "text", "sub_type": "notification", message: t("85%... Big Jump + mob ") }],
		"h-434-5000-55": [{ "type": "text", "sub_type": "notification", message: t("55%... Big Jump + mob ") }],
		"h-434-5000-25": [{ "type": "text", "sub_type": "notification", message: t("25%... Big Jump + mob ") }],
		"h-434-5000-10": [{ "type": "text", "sub_type": "notification", message: t("10%... Big Jump + mob ") }],
		"s-434-5000-1103-0": [
		...
		"s-434-5000-1118-0": [{ type: "text", sub_type: "message", message: t("Slow Jump + mobs") }],
		"s-434-5000-2118-0": [{ type: "text", sub_type: "message", message: t("Fast Jump + mobs") }],
		"s-434-5000-1120-0": [
			{ type: "text", sub_type: "message", message: t("Stun + reclining") },
			{ type: "spawn", func: "circle", args: [false, 553, 0, 150, 0, 680, 0, 7000] }
		],
		"s-434-5000-1124-0": [{ type: "text", sub_type: "message", message: t("Slow") }],
		"s-434-5000-2124-0": [{ type: "text", sub_type: "message", message: t("Fast") }],
		"s-434-5000-1127-0": [{ type: "text", sub_type: "message", message: t("Debuff") }],
		"ns-434-5002": [
		...
		"s-434-6000-1107-0": [{ type: "text", sub_type: "message", message: t("Boms") }],
		"s-434-6000-1109-0": [
		...
		"s-434-6000-1111-0": [{ type: "text", sub_type: "message", message: t("Left kick") }],
		"s-434-6000-1112-0": [{ type: "text", sub_type: "message", message: t("Right kick") }],
		"s-434-6000-1113-0": [{ type: "text", sub_type: "message", message: t("Laser") }],
		"s-434-6000-1113-1": [{ type: "text", sub_type: "message", message: t("dodge") }],
		"s-434-6000-1133-0": [
		...
		"s-434-9000-1117-0": [{ type: "text", sub_type: "message", message: t("Front") }],
		"s-434-9000-1302-0": [
		...
		"s-434-9000-1301-0": [{ type: "text", sub_type: "message", message: t("Scream") }],
		...
		"s-434-10000-1103-0": [{ type: "text", sub_type: "message", message: t("Frontal Attack") }],
		"s-434-10000-1205-0": [{ type: "text", sub_type: "message", message: t("Teleport") }],
		"s-434-10000-1102-0": [{ type: "text", sub_type: "message", message: t("In > Out") }],
		"s-434-10000-1113-0": [{ type: "text", sub_type: "message", message: t("Left Hand Attack") }],
		"s-434-10000-1105-0": [{ type: "text", sub_type: "message", message: t("Right Hand Attack") }],
		"s-434-10000-1112-0": [{ type: "func", func: debuff_event, args: [true, 0] }],
		"s-434-10000-1108-0": [{ type: "text", sub_type: "message", message: t("Target Attack") }],
		"s-434-10000-1114-0": [{ type: "text", sub_type: "message", message: t("Back Attack") }],
		"s-434-10000-1115-0": [{ type: "text", sub_type: "message", message: t("Tail") }],
		"s-434-10000-1111-0": [{ type: "text", sub_type: "message", message: t("Frontal Attack") }],
		"s-434-10000-1109-0": [{ type: "text", sub_type: "message", message: t("AoE Target") }],
		"s-434-10000-1104-0": [{ type: "text", sub_type: "message", message: t("Stomp") }],
		"s-434-10000-1107-0": [{ type: "text", sub_type: "message", message: t("Laser Attack") },
		...
		"s-434-10000-1106-0": [{ type: "text", sub_type: "message", message: t("Target Bomb") }],
		"s-434-10000-1204-0": [{ type: "text", sub_type: "message", message: t("Big AoE (Run)") },
