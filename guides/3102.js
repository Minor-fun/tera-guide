...
module.exports = (dispatch, handlers, guide, lang) => {
	...
	return {
		...
		"s-3102-1000-1107-0": [{ type: "text", sub_type: "message", message: t("Spectral Throw (Bait)") },
			{ type: "text", sub_type: "message", delay: 1400, message: t("Dodge!") }
		],
		"s-3102-1000-2107-0": [{ type: "text", sub_type: "message", message: t("Spectral Throw (Bait)") },
			{ type: "text", sub_type: "message", delay: 1400, message: t("Dodge!") }
		],
		// Basic attacks
		"s-3102-1000-1103-0": [{ type: "text", sub_type: "message", message: t("2 Hits | Bleed") }],
		"s-3102-1000-2103-0": [{ type: "text", sub_type: "message", message: t("2 Hits | Bleed") }],
		"s-3102-1000-1113-0": [{ type: "text", sub_type: "message", message: t("4 Hits Combo") }],
		"s-3102-1000-2113-0": [{ type: "text", sub_type: "message", message: t("4 Hits Combo") }],
		"s-3102-1000-1105-0": [{ type: "text", sub_type: "message", message: t("Uppercut | Stun") }],
		"s-3102-1000-2105-0": [{ type: "text", sub_type: "message", message: t("Uppercut | Stun") }],
		"s-3102-1000-1106-0": [{ type: "text", sub_type: "message", message: t("Stun") }],
		"s-3102-1000-2106-0": [{ type: "text", sub_type: "message", message: t("Stun") }],
		// 120 > 114
		"s-3102-1000-1120-0": [
		...
		"s-3102-1000-1111-0": [{ type: "text", sub_type: "message", message: t("Leap (Stun)") },
			{ type: "text", sub_type: "message", delay: 1800, message: t("Dodge!") }
		],
		"s-3102-1000-2111-0": [{ type: "text", sub_type: "message", message: t("Leap (Stun)") },
			{ type: "text", sub_type: "message", delay: 1750, message: t("Dodge!") }
		],
		"s-3102-1000-1115-0": [
			{ type: "text", sub_type: "message", message: t("AOE Bombs (Gather)") }
		],
		"s-3102-1000-2115-0": [
			{ type: "text", sub_type: "message", message: t("AOE Bombs (Gather)") }
		],
		...
		"s-3102-1000-1304-0": [{ type: "text", sub_type: "message", message: t("Shield!") }],
		"s-3102-1000-2304-0": [{ type: "text", sub_type: "message", message: t("Shield!") }],
