...
module.exports = (dispatch, handlers, guide, lang) => {
	...
	return {
		...
		//
		"s-3032-1000-104-0": [{ type: "text", sub_type: "message", message: t("Random Jump") }],
		"s-3032-1000-105-0": [{ type: "text", sub_type: "message", message: t("Back") }],
		"s-3032-1000-110-0": [
		...
		"s-3032-2000-164-0": [{ type: "text", sub_type: "message", message: t("Counter Attack (bleed)") }],
		"s-3032-2000-166-0": [{ type: "text", sub_type: "message", message: t("Turn-back") }],
		"s-3032-2000-175-0": [
			{ type: "text", sub_type: "message", message: t("Incoming Stun") },
			{ type: "text", sub_type: "message", delay: 1500, message: t("Dodge") }
		],
		"s-3032-2000-178-0": [{ type: "text", sub_type: "message", message: t("Scratching (bleed)") }],
		"s-3032-2000-181-0": [
			{ type: "text", sub_type: "message", message: t("Rock Throw") },
			{ type: "spawn", func: "vector", args: [553, 90, 80, 10, 1000, 0, 4000] },
			{ type: "spawn", func: "vector", args: [553, 270, 80, 350, 1000, 0, 4000] }
		],
		"s-3032-2000-182-0": [{ type: "text", sub_type: "message", message: t("Knockdown") }],
		"s-3032-2000-185-0": [
		...
		"s-3032-2000-207-0": [{ type: "text", sub_type: "message", message: t("Phantom x5 (bleed)") }],
		"s-3032-2000-212-0": [{ type: "text", sub_type: "message", message: t("Flash (bleed)") }]
	};
};