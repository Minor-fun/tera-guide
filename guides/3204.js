...
module.exports = (dispatch, handlers, guide, lang) => {
	...
	return {
		...
		"qb-3204-1000-32042000": [{ type: "text", sub_type: "message", message: t("Arrows + Line") }],
		"qb-3204-1000-32042006": [
			{ type: "text", sub_type: "message", message: t("Cage") },
			{ type: "text", sub_type: "alert", message: t("Cage soon..."), delay: 100000 }
		],
		"qb-3204-1000-32042009": [
			{ type: "text", sub_type: "message", message: t("Skeletons") },
			{ type: "text", sub_type: "alert", message: t("Skeletons soon..."), delay: 220000 }
		],

		"h-3204-1000-90": [{ type: "text", sub_type: "message", message: t("90%") }],
		"h-3204-1000-75": [{ type: "text", sub_type: "message", message: t("75%") }],
		"h-3204-1000-40": [{ type: "text", sub_type: "message", message: t("40%") }],
		...
		"s-3204-1000-112-0": [{ type: "text", sub_type: "message", message: t("Wave Forward") },
			{ type: "spawn", func: "vector", args: [553, 0, 0, 70, 500, 0, 2000] },
			{ type: "spawn", func: "vector", args: [553, 0, 0, 290, 500, 0, 2000] }
		],
		"s-3204-1000-114-0": [{ type: "text", sub_type: "message", message: t("Inner + Outer AOEs") }],
		"s-3204-1000-116-0": [
		...
		"s-3204-1000-119-0": [{ type: "text", sub_type: "message", message: t("Two Strikes") }],
		"s-3204-1000-120-0": [
		...
		"s-3204-1000-123-0": [{ type: "text", sub_type: "message", message: t("Spin") }],
		"s-3204-1000-125-0": [{ type: "text", sub_type: "message", message: t("Stun (Tank)") }],
		"s-3204-1000-127-0": [
		...
		"s-3204-1000-156-0": [{ type: "text", sub_type: "message", message: t("Get Skulls") }],
		"s-3204-1000-157-0": [
			{ type: "text", sub_type: "message", message: t("3 seconds") },
			{ type: "text", sub_type: "message", message: t("Gather!"), delay: 2000 }],
		"s-3204-1000-158-0": [
			{ type: "text", sub_type: "message", message: t("6 seconds") },
			{ type: "text", sub_type: "message", message: t("Gather!"), delay: 5000 }
		],
		"s-3204-1000-159-0": [
