...
module.exports = (dispatch, handlers, guide, lang, t) => {
	...
	return {
		// Mini BOSS 1
		"s-716-91650-1102-0": [{ type: "text", sub_type: "message", message: t("AoE Stun") }],
		"s-716-91650-1104-0": [{ type: "text", sub_type: "message", message: t("Random Target (Stun)") },
		...
		"s-716-91650-1105-0": [{ type: "text", sub_type: "message", message: t("Jump + Headbutt on Target") }],
		"s-716-91650-1106-0": [{ type: "text", sub_type: "message", message: t("Headbutt (Target)") }],
		...
		// Mini BOSS 2
		"ns-716-91606": [
			{ type: "spawn", sub_type: "build_object", id: 1, sub_delay: 99999999, pos: { x: 57046, y: 129715, z: 2370, w: -1.08 }, ownerName: "AIM LASER", message: t("LASER") }, //1
			{ type: "spawn", sub_type: "item", id: 88704, sub_delay: 99999999, pos: { x: 57046, y: 129715, z: 2370, w: -1.08 } }, //1
			{ type: "spawn", sub_type: "build_object", id: 1, sub_delay: 99999999, pos: { x: 58360, y: 129712, z: 2370, w: -2.09 }, ownerName: "AIM LASER", message: t("LASER") }, //2
			{ type: "spawn", sub_type: "item", id: 88704, sub_delay: 99999999, pos: { x: 58360, y: 129712, z: 2370, w: -2.09 } }, //2
			{ type: "spawn", sub_type: "build_object", id: 1, sub_delay: 99999999, pos: { x: 58361, y: 126912, z: 2370, w: 2.00 }, ownerName: "AIM LASER", message: t("LASER") }, //3
			{ type: "spawn", sub_type: "item", id: 88704, sub_delay: 99999999, pos: { x: 58361, y: 126912, z: 2370, w: 2.00 } }, //3
			{ type: "spawn", sub_type: "build_object", id: 1, sub_delay: 99999999, pos: { x: 57048, y: 126914, z: 2370, w: 1.06 }, ownerName: "AIM LASER", message: t("LASER") }, //4
			{ type: "spawn", sub_type: "item", id: 88704, sub_delay: 99999999, pos: { x: 57048, y: 126914, z: 2370, w: 1.06 } }, //4
			{ type: "spawn", sub_type: "build_object", id: 1, sub_delay: 99999999, pos: { x: 59088, y: 127837, z: 2370, w: 2.76 }, ownerName: "AIM LASER", message: t("LASER") }, //4 esquerda atras
			{ type: "spawn", sub_type: "item", id: 88704, sub_delay: 99999999, pos: { x: 59088, y: 127837, z: 2370, w: 2.76 } }, //4 esquerda atras
			{ type: "spawn", sub_type: "build_object", id: 1, sub_delay: 99999999, pos: { x: 56343, y: 127836, z: 2370, w: 0.39 }, ownerName: "AIM LASER", message: t("LASER") }, //4 direita atras
			{ type: "spawn", sub_type: "item", id: 88704, sub_delay: 99999999, pos: { x: 56343, y: 127836, z: 2370, w: 0.39 } }, //4 direita atras
			{ type: "spawn", sub_type: "build_object", id: 1, sub_delay: 99999999, pos: { x: 56339, y: 128908, z: 2370, w: -0.38 }, ownerName: "AIM LASER", message: t("LASER") }, //4 direita frente
			{ type: "spawn", sub_type: "item", id: 88704, sub_delay: 99999999, pos: { x: 56339, y: 128908, z: 2370, w: -0.38 } }, //4 direita frente
			{ type: "spawn", sub_type: "build_object", id: 1, sub_delay: 99999999, pos: { x: 59087, y: 128907, z: 2370, w: -2.75 }, ownerName: "AIM LASER", message: t("LASER") }, //4 esquerda frente
			{ type: "spawn", sub_type: "item", id: 88704, sub_delay: 99999999, pos: { x: 59087, y: 128907, z: 2370, w: -2.75 } }//4 esquerda frente
		],
		"s-716-91606-1304-0": [{ type: "text", sub_type: "message", message: t("Random Laser") }
		],
		"s-716-91606-1102-0": [{ type: "text", sub_type: "message", message: t("Spin") },
			{ type: "spawn", func: "circle", args: [false, 553, 0, -15, 15, 280, 0, 2500] }
		],
		"s-716-91606-1106-0": [{ type: "text", sub_type: "message", message: t("Frontal Combo (Target)") },
		...
		"s-716-91606-1105-0": [{ type: "text", sub_type: "message", message: t("Jump (Dodge)") }],
		"s-716-91606-1107-0": [{ type: "text", sub_type: "message", message: t("Many Hits (Target)") }],
		"s-716-91606-1302-0": [{ type: "text", sub_type: "message", message: t("Laser (PROTECT)") },
			{ type: "spawn", func: "vector", args: [912, 360, 50, 0, 900, 0, 4000] }
		],
		"s-716-91606-1304-1": [{ type: "text", sub_type: "message", message: t("Dodge"), delay: 600 }],
		"s-716-91606-1305-0": [{ type: "text", sub_type: "message", message: t("AoEs") },
		...
		"qb-716-91606-916027": [{ type: "text", sub_type: "message", message: t("Target (Push)") }],
		"s-716-91606-1301-0": [
		...
		"qb-716-91606-916007": [{ type: "text", sub_type: "message", message: t("GATHER") }],
		...
		"s-716-1001-1112-0": [{ type: "text", sub_type: "message", message: t("Back Jump") }],
		"s-716-1001-1303-0": [{ type: "text", sub_type: "message", message: t("Spin Attack") }],
		...
		"s-716-1001-1401-0": [{ type: "text", sub_type: "message", message: t("Right") },
		...
		"s-716-1001-1402-0": [{ type: "text", sub_type: "message", message: t("Left") },
		...
		"h-716-1000-94": [{ type: "text", sub_type: "message", message: t("94%") }],
		"h-716-1000-49": [{ type: "text", sub_type: "message", message: t("49%") }],
		"s-716-1000-1101-0": [{ type: "func", func: boss_backattack_event }],
		"s-716-1000-1102-0": [{ type: "func", func: () => back_time = new Date() }],
		"s-716-1000-1112-0": [{ type: "text", sub_type: "message", message: t("Back Move") }],
		...
		"s-716-1000-1115-0": [
			...
			{ type: "text", sub_type: "message", delay: 4200, message: t("Dodge") }
		],
		"s-716-1000-1117-0": [{ type: "text", sub_type: "message", message: t("Front") }],
		"s-716-1000-1118-0": [
		...
		"s-716-1000-1303-0": [{ type: "text", sub_type: "message", message: t("Spin Attack") }],
		"s-716-1000-1801-0": [{ type: "text", sub_type: "message", message: t("Incoming Stun") }],
		"s-716-1000-1401-0": [{ type: "text", sub_type: "message", message: t("Right") },
			{ type: "spawn", func: "semicircle", args: [0, 180, 912, 0, 0, 20, 160, 0, 1500] },
			{ type: "spawn", func: "semicircle", args: [0, 180, 912, 0, 0, 12, 220, 0, 1500] },
			{ type: "spawn", func: "semicircle", args: [0, 180, 912, 0, 0, 10, 300, 0, 1500] },
			{ type: "spawn", func: "semicircle", args: [0, 180, 912, 0, 0, 8, 360, 0, 1500] },
		...
		"s-716-1000-1402-0": [{ type: "text", sub_type: "message", message: t("Left") },
			{ type: "spawn", func: "semicircle", args: [180, 360, 912, 0, 0, 20, 160, 0, 1500] },
			{ type: "spawn", func: "semicircle", args: [180, 360, 912, 0, 0, 12, 220, 0, 1500] },
			{ type: "spawn", func: "semicircle", args: [180, 360, 912, 0, 0, 10, 300, 0, 1500] },
			{ type: "spawn", func: "semicircle", args: [180, 360, 912, 0, 0, 8, 360, 0, 1500] },
