...
module.exports = (dispatch, handlers, guide, lang, t) => {
	...
	function thirdboss_stacks_event(count) {
		...
		if (count === 0) {
			handlers.event([
				{ type: "text", sub_type: "notification", message: t("Stacks removed"), speech: false },
				{ type: "text", sub_type: "message", message: t("Stacks removed") }
			]);
		} else {
			thirdboss_stacks_timer = dispatch.setTimeout(() => {
				handlers.event([
					{ type: "text", sub_type: "notification", message: t("{count} stacks", { count: count }), speech: false },
					{ type: "text", sub_type: "message", message: t("{count} stacks", { count: count }) }
				]);
			}, 500);
		}
	}
	...
	return {
		...
		"s-468-1000-102-0": [{ type: "text", sub_type: "message", message: t("Turn Attack") }],
		"s-468-1000-106-0": [{ type: "text", sub_type: "message", message: t("Three Combo") }],
		"s-468-1000-107-0": [{ type: "text", sub_type: "message", message: t("Front Combo") }],
		"s-468-1000-301-0": [{ type: "text", sub_type: "message", message: t("Wave Front") }],
		"s-468-1000-304-0": [{ type: "text", sub_type: "message", message: t("Strike (Target)") }],
		"s-468-1000-304-1": [{ type: "text", sub_type: "message", message: t("Dodge"), delay: 700 }],
		"s-468-1000-305-0": [{ type: "text", sub_type: "message", message: t("8 explosions") }],
		"s-468-1000-306-0": [{ type: "text", sub_type: "message", message: t("Stones") }], // 306 -> 307
		...
		"s-468-2000-101-0": [{ type: "text", sub_type: "message", message: t("Fireball") }],
		"s-468-2000-102-0": [{ type: "text", sub_type: "message", message: t("Drain") }],
		"s-468-2000-103-0": [{ type: "text", sub_type: "message", message: t("Explosion") }],
		"s-468-2000-104-0": [{ type: "text", sub_type: "message", message: t("Dark Frame") }],
		"s-468-2000-110-0": [{ type: "text", sub_type: "message", message: t("Front Attack") }],
		"s-468-2000-111-0": [{ type: "text", sub_type: "message", message: t("360") }], // 114 -> 111
		"s-468-2000-112-0": [{ type: "text", sub_type: "message", message: t("Back Attack") }],
		"s-468-2000-117-0": [{ type: "text", sub_type: "message", message: t("Laser (Target)") }],
		"s-468-2000-117-2": [{ type: "text", sub_type: "message", message: t("Dodge"), delay: 600 }],
		"s-468-2000-118-0": [{ type: "text", sub_type: "message", message: t("Laser") }],
		"s-468-2000-307-0": [{ type: "text", sub_type: "message", message: t("Donut") }],
		"s-468-2000-501-0": [{ type: "text", sub_type: "message", message: t("Charging") }],
		...
		"h-468-3000-60": [{ type: "text", sub_type: "message", message: t("60%") }],
		"h-468-3000-40": [{ type: "text", sub_type: "message", message: t("40%") }],
		//
		"s-468-3000-101-0": [
		...
		//
		"s-468-3000-110-0": [{ type: "text", sub_type: "message", message: t("Back Move") }],
		"s-468-3000-111-0": [{ type: "text", sub_type: "message", message: t("360 attack") }],
		"s-468-3000-114-0": [{ type: "text", sub_type: "message", message: t("Pull") }], // 114 -> 111
		"s-468-3000-115-0": [{ type: "text", sub_type: "message", message: t("Circles") }], // 202/205 -> 115
		"s-468-3000-115-1": [{ type: "text", sub_type: "message", message: t("Dodge"), delay: 150 }],
		"s-468-3000-117-0": [{ type: "text", sub_type: "message", message: t("Jump") }], // 503 -> 117
		...
		"s-468-3000-136-0": [{ type: "text", sub_type: "message", message: t("Donut") }], // 135 -> 136
		"s-468-3000-202-0": [{ type: "text", sub_type: "message", message: t("Target Throw") }], // 503 -> 201 -> 202
		"s-468-3000-205-0": [{ type: "text", sub_type: "message", message: t("Target Throw") }], // 503 -> 117 -> 203 -> 204 -> 205
		"s-468-3000-206-0": [{ type: "text", sub_type: "message", message: t("Pike (Target)") }], // 206 -> 207
		"s-468-3000-302-0": [
		...
		"s-468-3000-302-1": [{ type: "text", sub_type: "message", message: t("Dodge"), delay: 1600 }],
		"s-468-3000-501-0": [
			{ type: "text", sub_type: "message", message: t("Cage") },
			{ type: "text", sub_type: "alert",
				message: t("Stand in the red zone to remove stack"),
		...
		"s-468-3000-503-0": [{ type: "text", sub_type: "message", message: t("Target Lockon") }], // qb 468050 -> 503
		"s-468-3000-504-0": [{ type: "text", sub_type: "message", message: t("Mobs Summon") }],
		// "s-468-3000-508-0": [{ type: "text", sub_type: "message", message: t("Buff") }],
		"dm-0-0-9068013": [
