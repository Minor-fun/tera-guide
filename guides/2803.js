...
module.exports = (dispatch, handlers, guide, lang) => {
	...
	return {
		...
		"s-2803-1000-1-0": [{ type: "text", sub_type: "message", message: "Double Base Slash", message_RU: "", message_zh: "双重基础斩击" }],
		"s-2803-1000-2-0": [{ type: "text", sub_type: "message", message: "Spin", message_RU: "", message_zh: "旋转" }],
		"s-2803-1000-3-0": [{  type: "text", class_position: "tank", sub_type: "message", message: "Knock Up", message_RU: "", message_zh: "击飞" }],
		"s-2803-1000-4-0": [{ type: "text", sub_type: "message", message: "Spin", message_RU: "", message_zh: "旋转" }],
		"s-2803-1000-5-0": [{ type: "text", class_position: "tank", sub_type: "message", message: "Stun", message_RU: "", message_zh: "晕眩" }],
		"s-2803-1000-6-0": [{ type: "text", sub_type: "message", message: "Double Spinning", message_RU: "", message_zh: "双重旋转" }],
		"s-2803-1000-7-0": [
			{ type: "text", sub_type: "message", message: "Pull + KD", message_RU: "", message_zh: "拉人 + 击倒", class_position: ["tank", "dps"]},
			{ type: "text", sub_type: "message", message: "Kaia", message_RU: "", message_zh: "套盾", class_position: ["mystic", "priest"]},
		],
		"s-2803-1000-8-0": [{ type: "text", class_position: "tank", sub_type: "message", message: "Tank Buster", message_RU: "", message_zh: "破防攻击" }],
		"s-2803-1000-9-0": [{ type: "text", sub_type: "message", message: "DODGE", message_RU: "", message_zh: "躲避" }],
		"s-2803-1000-10-0": [{ type: "text", sub_type: "message", message: "Spinning DODGE", message_RU: "", message_zh: "旋转 躲避" }],
		...
		"s-2803-1000-113-0": [{ type: "text", sub_type: "message", message: "Overhead Slash", message_RU: "", message_zh: "上劈" }],
		"s-2803-1000-101-0": [{ type: "text", sub_type: "message", message: "SHEILD", message_RU: "", message_zh: "破盾" }],
		"s-2803-1000-102-0": [{ type: "text", sub_type: "message", message: "PLAGUE/REGRESS", message_RU: "", message_zh: "解buff" }],
		...
		"s-2803-1000-305-0": [{ type: "text", sub_type: "message", message: "RuneBurst", message_RU: "", message_zh: "符文爆发" }],
