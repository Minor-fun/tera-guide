...
module.exports = (dispatch, handlers, guide, lang, t) => {
	...
	return {
		...
		"s-3037-1000-1113-0": [{ type: "text", sub_type: "message", message: t("Throw (Bait)") }],
		"s-3037-1000-1114-0": [
			{ type: "text", sub_type: "message", message: t("Front Slam") },
			{ type: "spawn", func: "circle", args: [false, 553, 356, 260, 10, 320, 100, 3000] }
		],
		"s-3037-1000-1115-0": [{ type: "text", sub_type: "message", delay: 1100, message: t("Dodge") }], // Knockup
		"s-3037-1000-1116-0": [
		...
		"s-3037-1000-1117-0": [{ type: "text", sub_type: "message", message: t("Jump (Bait)") }],
		"s-3037-1000-1118-0": [{ type: "text", sub_type: "message", message: t("Jump (Tank)") }],
		...
		"s-3037-1000-1138-0": [{ type: "text", sub_type: "message", delay: 1100, message: t("Dodge") }], // Knockup (Bait)
		"s-3037-1000-1139-0": [
			{ type: "text", sub_type: "message", delay: 550, message: t("Dodge!") },
		...
		"s-3037-1000-2115-0": [{ type: "text", sub_type: "message", message: t("Dodge") }], // Knockup
		...
		"s-3037-1000-2138-0": [{ type: "text", sub_type: "message", message: t("Dodge") }], // Knockup (Bait)
		...
		"s-3037-2000-1107-0": [{ type: "text", sub_type: "message", message: t("4 Hit (3)") }],
		"s-3037-2000-1108-0": [
			{ type: "text", sub_type: "message", message: t("Back Throw") },
			{ type: "spawn", func: "circle", args: [false, 553, 180, 250, 12, 300, 100, 3000] }
		],
		...
		"s-3037-2000-1113-0": [{ type: "text", sub_type: "message", message: t("Throw (Bait)") }],
		"s-3037-2000-1114-0": [
			{ type: "text", sub_type: "message", message: t("Front Slam") },
			{ type: "spawn", func: "circle", args: [false, 553, 356, 260, 10, 320, 100, 3000] }
		],
		"s-3037-2000-1115-0": [{ type: "text", sub_type: "message", delay: 1100, message: t("Dodge") }], // Knockup
		"s-3037-2000-1116-0": [
			{ type: "text", sub_type: "message", message: t("Donuts (In)") },
		...
		"s-3037-2000-1117-0": [{ type: "text", sub_type: "message", message: t("Jump (Bait)") }],
		"s-3037-2000-1118-0": [{ type: "text", sub_type: "message", message: t("Jump (Tank)") }],
		...
		"s-3037-2000-1138-0": [{ type: "text", sub_type: "message", delay: 900, message: t("Dodge") }], // Knockup (Bait)
		"s-3037-2000-1139-0": [{ type: "text", sub_type: "message", delay: 200, message: t("Dodge!") }],
		"s-3037-2000-1140-0": [
			{ type: "text", sub_type: "message", message: t("Waves (Right)") },
			{ type: "func", func: waves_event },
			{ type: "spawn", func: "marker", args: [false, 323, 125, 0, 2533, false, ["safe", "safe"]] },
		...
		"s-3037-2000-1308-0": [{ type: "text", sub_type: "message", message: t("Stun (1)") }],
		"s-3037-2000-1309-0": [{ type: "text", sub_type: "message", message: t("Stun (2)") }],
		"s-3037-2000-1310-0": [{ type: "text", sub_type: "message", message: t("Stun (3)") }],
		"s-3037-2000-1311-0": [
		...
		"s-3037-2000-2115-0": [{ type: "text", sub_type: "message", delay: 100, message: t("Dodge") }], // Knockup
		...
		"s-3037-2000-2138-0": [{ type: "text", sub_type: "message", message: t("Dodge") }], // Knockup (Bait)
		...
		"ab-3037-2000-30372303": [{ type: "text", sub_type: "message", message: t("Plague/Regress") }],
