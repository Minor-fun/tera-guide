...
module.exports = (dispatch, handlers, guide, lang) => {
	...
	return {
		...
		"s-3037-1000-1113-0": [{ type: "text", sub_type: "message", message: "Throw (Bait)", message_RU: "Молот (байт)", message_zh: "诱导投掷" }],
		"s-3037-1000-1114-0": [
		...
		"s-3037-1000-1115-0": [{ type: "text", sub_type: "message", delay: 1100, message: "Dodge", message_RU: "Эвейд", message_zh: "闪避" }], // Knockup
		"s-3037-1000-1116-0": [
		...
		"s-3037-1000-1117-0": [{ type: "text", sub_type: "message", message: "Jump (Bait)", message_RU: "Прыжок (байт)", message_zh: "诱导跳跃" }],
		"s-3037-1000-1118-0": [{ type: "text", sub_type: "message", message: "Jump (Tank)", message_RU: "Прыжок (танк)", message_zh: "跳坦克" }],
		...
		"s-3037-1000-1138-0": [{ type: "text", sub_type: "message", delay: 1100, message: "Dodge", message_RU: "Эвейд", message_zh: "闪避" }], // Knockup (Bait)
		"s-3037-1000-1139-0": [
		...
		"s-3037-1000-2115-0": [{ type: "text", sub_type: "message", message: "Dodge", message_RU: "Эвейд", message_zh: "闪避" }], // Knockup
		...
		"s-3037-1000-2138-0": [{ type: "text", sub_type: "message", message: "Dodge", message_RU: "Эвейд", message_zh: "闪避" }], // Knockup (Bait)
		...
		"s-3037-2000-1107-0": [{ type: "text", sub_type: "message", message: "4 Hit (3)", message_RU: "4", message_zh: "第四击" }],
		"s-3037-2000-1108-0": [
			{ type: "text", sub_type: "message", message: "Back Throw", message_RU: "Стан назад", message_zh: "背后眩晕" },
			{ type: "spawn", func: "circle", args: [false, 553, 180, 250, 12, 300, 100, 3000] }
		],
		...
		"s-3037-2000-1113-0": [{ type: "text", sub_type: "message", message: "Throw (Bait)", message_RU: "Молот (байт)", message_zh: "诱导投掷" }],
		"s-3037-2000-1114-0": [
			{ type: "text", sub_type: "message", message: "Front Slam", message_RU: "Удар назад", message_zh: "背后攻击" },
			{ type: "spawn", func: "circle", args: [false, 553, 356, 260, 10, 320, 100, 3000] }
		],
		"s-3037-2000-1115-0": [{ type: "text", sub_type: "message", delay: 1100, message: "Dodge", message_RU: "Эвейд", message_zh: "闪避" }], // Knockup
		"s-3037-2000-1116-0": [
			{ type: "text", sub_type: "message", message: "Donuts (In)", message_RU: "Бублики (к нему)", message_zh: "环形靠近" },
		...
		"s-3037-2000-1117-0": [{ type: "text", sub_type: "message", message: "Jump (Bait)", message_RU: "Прыжок (байт)", message_zh: "诱导跳跃" }],
		"s-3037-2000-1118-0": [{ type: "text", sub_type: "message", message: "Jump (Tank)", message_RU: "Прыжок (танк)", message_zh: "跳坦克" }],
		...
		"s-3037-2000-1138-0": [{ type: "text", sub_type: "message", delay: 900, message: "Dodge", message_RU: "Эвейд", message_zh: "闪避" }], // Knockup (Bait)
		"s-3037-2000-1139-0": [{ type: "text", sub_type: "message", delay: 200, message: "Dodge!", message_RU: "Эвейд!", message_zh: "闪避！" }],
		"s-3037-2000-1140-0": [
			{ type: "text", sub_type: "message", message: "Waves (Right)", message_RU: "Волны (правая)", message_zh: "右半月" },
			{ type: "func", func: waves_event },
			{ type: "spawn", func: "marker", args: [false, 323, 125, 0, 2533, false, ["safe", "safe"]] },
		...
		"s-3037-2000-1308-0": [{ type: "text", sub_type: "message", message: "Stun (1)", message_RU: "Стан (1)", message_zh: "眩晕一" }],
		"s-3037-2000-1309-0": [{ type: "text", sub_type: "message", message: "Stun (2)", message_RU: "Стан (2)", message_zh: "眩晕二" }],
		"s-3037-2000-1310-0": [{ type: "text", sub_type: "message", message: "Stun (3)", message_RU: "Стан (3)", message_zh: "眩晕三" }],
		"s-3037-2000-1311-0": [
		...
		"s-3037-2000-2115-0": [{ type: "text", sub_type: "message", delay: 100, message: "Dodge", message_RU: "Эвейд", message_zh: "闪避" }], // Knockup
		...
		"s-3037-2000-2138-0": [{ type: "text", sub_type: "message", message: "Dodge", message_RU: "Эвейд", message_zh: "闪避" }], // Knockup (Bait)
		...
		"ab-3037-2000-30372303": [{ type: "text", sub_type: "message", message: "Plague/Regress", message_RU: "Регресс", message_zh: "驱散" }],
