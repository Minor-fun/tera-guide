...
module.exports = (dispatch, handlers, guide, lang) => {
	...
	return {
		...
		"s-448-2000-1107-0": [{ type: "text", sub_type: "message", message: "4 Hit (3)", message_RU: "4", message_zh: "第四击" }],

		"s-448-2000-3202-0": [ // After 4 Hit Donuts Enraged
			{ type: "text", sub_type: "message", message: "IN - OUT ", message_RU: "От него > К нему", message_zh: "靠近再远离" },
		...
		"s-448-2000-1113-0": [{ type: "text", sub_type: "message", message: "Throw (Bait)", message_RU: "Молот (байт)", message_zh: "诱导投掷" }],
		"s-448-2000-1114-0": [
		...
		"s-448-2000-1115-0": [{ type: "text", sub_type: "message", delay: 1100, message: "Dodge", message_RU: "Эвейд", message_zh: "闪避" }], // Knockup
		"s-448-2000-1116-0": [
		...
		"s-448-2000-1117-0": [{ type: "text", sub_type: "message", message: "Jump (Bait)", message_RU: "Прыжок (байт)", message_zh: "诱导跳跃" }],
		"s-448-2000-1118-0": [{ type: "text", sub_type: "message", message: "Jump (Tank)", message_RU: "Прыжок (танк)", message_zh: "跳坦克" }],
		...
		"s-448-2000-1138-0": [{ type: "text", sub_type: "message", delay: 900, message: "Dodge", message_RU: "Эвейд", message_zh: "闪避" }], // Knockup (Bait)
		"s-448-2000-1139-0": [{ type: "text", sub_type: "message", delay: 200, message: "Dodge!", message_RU: "Эвейд!", message_zh: "闪避！" }],
		"s-448-2000-1140-0": [
		...
		"s-448-2000-1308-0": [{ type: "text", sub_type: "message", message: "Stun (1)", message_RU: "Стан (1)", message_zh: "眩晕一" }],
		"s-448-2000-1309-0": [{ type: "text", sub_type: "message", message: "Stun (2)", message_RU: "Стан (2)", message_zh: "眩晕二" }],
		"s-448-2000-1310-0": [{ type: "text", sub_type: "message", message: "Stun (3)", message_RU: "Стан (3)", message_zh: "眩晕三" }],
		"s-448-2000-1311-0": [
		...
		"s-448-2000-2112-0": [
			{ type: "text", sub_type: "notification", delay: 1000, message: "Perfect Defense x2 (Slow)", message_RU: "Идеальный блок x2 (медленно)", message_zh: "慢速完美格挡两次" },
			{ type: "text", sub_type: "notification", delay: 2400, message: "Block/Dodge", message_RU: "Блок/Эвейд", message_zh: "格挡/闪避" },
		...
		"s-448-2000-2115-0": [{ type: "text", sub_type: "message", delay: 100, message: "Dodge", message_RU: "Эвейд", message_zh: "闪避" }], // Knockup
		...
		"s-448-2000-2135-0": [
			{ type: "text", sub_type: "notification", message: "Perfect Defense x2", message_RU: "Идеальный блок x2", message_zh: "完美格挡两次" },
			{ type: "text", sub_type: "notification", delay: 800, message: "Block/Dodge", message_RU: "Блок/Эвейд", message_zh: "格挡/闪避" },
			{ type: "spawn", func: "circle", args: [false, 553, 356, 220, 12, 210, 100, 4000] }
		],
		"s-448-2000-2137-0": "s-448-2000-1137-0",
		"s-448-2000-2138-0": [{ type: "text", sub_type: "message", message: "Dodge", message_RU: "Эвейд", message_zh: "闪避" }], // Knockup (Bait)
		...
		"ab-448-2000-90442303": [{ type: "text", sub_type: "message", message: "Plague/Regress", message_RU: "Регресс", message_zh: "驱散" }],
