...
module.exports = (dispatch, handlers, guide, lang) => {
	...
	dispatch.hook("S_ABNORMALITY_BEGIN", dispatch._mod.majorPatchVersion >= 107 ? 5 : 4, event => {
		if (event.id === 32051007) {
			if (dispatch._mod.game.me.is(event.target)) {
				handlers.text({ sub_type: "notification", message: "Lasers on you", message_RU: "Лазеры на тебе", message_zh: "激光点名" });
			} else {
	...
	return {
		...
		"h-3205-1000-80": [{ type: "text", sub_type: "message", message: "80%", message_RU: "80%", message_zh: "百分之八十" }],
		"h-3205-1000-45": [{ type: "text", sub_type: "message", message: "45%", message_RU: "45%", message_zh: "百分之四十五" }],
		"h-3205-1000-40": [{ type: "text", sub_type: "message", message: "40%", message_RU: "40%", message_zh: "百分之四十" }],

		"s-3205-1000-101-0": [{ type: "text", sub_type: "message", message: "Front Swing", message_RU: "Удар вперед", message_zh: "前方挥击" }],
		"s-3205-1000-102-0": [
		...
		"s-3205-1000-106-0": [{ type: "text", sub_type: "message", message: "Blades Front", message_RU: "Лезвия вперед", message_zh: "前方刀片" }],
		"s-3205-1000-112-0": [
		...
		"s-3205-1000-119-0": [{ type: "text", sub_type: "message", message: "Cut", message_RU: "Разрез", message_zh: "切割" }],
		"s-3205-1000-120-0": [{ type: "text", sub_type: "message", message: "Storm", message_RU: "Шторм", message_zh: "风暴" }],
		"s-3205-1000-107-0": [
		...
		"s-3205-1000-117-0": [{ type: "text", sub_type: "message", message: "Kick", message_RU: "Удар ногой", message_zh: "踢击" }],
		"s-3205-1000-118-0": [{ type: "text", sub_type: "message", message: "Kick (Dodge)", message_RU: "Удар ногой (эвейд)", message_zh: "踢击 (闪避)" }],
		...
		"qb-3205-1000-32051002": [{ type: "text", sub_type: "message", message: "Shield!", message_RU: "Щит!", message_zh: "护盾！" }], // <50%
		"s-3205-1000-123-0": [{ type: "text", sub_type: "message", message: "Break Failure", message_RU: "Щит не пробит", message_zh: "破盾失败" }],

		"qb-3205-1000-32051004": [{ type: "text", sub_type: "message", message: "Bait (Lasers)", message_RU: "Байт (лазеры)", message_zh: "点名 (激光)" }], // range check
		"qb-3205-1000-32051005": [{ type: "text", sub_type: "message", message: "Bait", message_RU: "Байт", message_zh: "点名" }], // get stun
		"qb-3205-1000-32051006": [{ type: "text", sub_type: "message", message: "Bait", message_RU: "Байт", message_zh: "点名" }], // cast ress
		"qb-3205-1000-32051007": [{ type: "text", sub_type: "message", message: "Puddles", message_RU: "Лужи", message_zh: "毒圈" }], // <45%
		"qb-3205-1000-32051008": [{ type: "text", sub_type: "message", message: "Puddles", message_RU: "Лужи", message_zh: "毒圈" }],
		...
		"s-3205-1000-305-0": [ // blue
			{ type: "text", sub_type: "message", message: "Wave (Dodge)", message_RU: "Волна (эвейд)", message_zh: "扩散圈 (闪避)", delay: 100 },
			{ type: "text", sub_type: "message", message: "Plague of Exhaustion", message_RU: "Чума/регресс", class_position: "priest", delay: 1000, message_zh: "解buff" },
			{ type: "text", sub_type: "message", message: "Regression", message_RU: "Регресс", class_position: "mystic", delay: 1000, message_zh: "解buff" },
			{ type: "text", sub_type: "message", message: "Give Stun!", message_RU: "Дать стан!", message_zh: "给眩晕！", delay: 2000 }
		],
		"s-3205-1000-121-0": [{ type: "text", sub_type: "message", message: "AoE", message_RU: "АоЕ", message_zh: "AOE" }], // red
		"s-3205-1000-122-0": [{ type: "text", sub_type: "message", message: "AoE", message_RU: "АоЕ", message_zh: "AOE" }], // blue
