...
module.exports = (dispatch, handlers, guide, lang, t) => {
	...
	function thirdboss_sattack_event(skillid) {
		...
		if ([1160, 1190].includes(skillid)) {
			handlers.text({ sub_type: "message", delay: delay, message: t("Right Safe") });
		}
		if ([1170, 1180].includes(skillid)) {
			handlers.text({ sub_type: "message", delay: delay, message: t("Left Safe") });
		}
		if ([1160, 1170, 1180, 1190].includes(skillid) && boss_seventy) { // <70%
			if (mech_reverse) {
				handlers.text({ sub_type: "message", message: t("Triple-S | Out") });
				handlers.text({ sub_type: "message", delay: 4500, message: t("Out") });
			} else {
				handlers.text({ sub_type: "message", message: t("Triple-S | In") });
				handlers.text({ sub_type: "message", delay: 4500, message: t("In") });
			}
	...
	return {
		...
		"qb-3034-1000-3034101": [{ type: "text", sub_type: "message", message: t("Pizza") }],
		"qb-3034-1000-3034102": [{ type: "text", sub_type: "message", message: t("AOE! Jump") }],
		"s-3034-1000-104-0": [{ type: "text", sub_type: "message", message: t("Front Clip") }],
		"s-3034-1000-108-0": [{ type: "text", sub_type: "message", message: t("Get Out") }], // крутилка
		"s-3034-1000-111-0": [{ type: "text", sub_type: "message", message: t("Back + Front") }],
		"s-3034-1000-112-0": [{ type: "text", sub_type: "message", message: t("Back") }],
		"s-3034-1001-205-0": [{ type: "text", sub_type: "message", message: t("Wind (Kaia)") }],
		...
		"s-3034-1000-304-0": [{ type: "text", sub_type: "message", message: t("Out") }],
		"s-3034-1000-305-0": [{ type: "text", sub_type: "message", message: t("In") }],
		"s-3034-1000-306-0": [{ type: "text", sub_type: "message", message: t("Bombs") }],
		"s-3034-1000-307-0": [{ type: "text", sub_type: "message", message: t("Pull") }],
		"s-3034-1000-309-0": [
		...
		// Safe: |||2|2||| > ||||1|||| > ||3|||3||
		"s-3034-2000-310-0": [{ type: "text", sub_type: "message", message: t("2 - 1 - 3") },
		...
		// Safe: ||||1|||| > ||3|||3|| > |||2|2|||
		"s-3034-2000-311-0": [{ type: "text", sub_type: "message", message: t("1 - 3 - 2") },
		...
		"h-3034-3000-70": [
			{ type: "text", sub_type: "message", message: t("70%") },
		...
		//
		"s-3034-3000-125-0": [{ type: "text", sub_type: "message", message: t("Front") }],
		"s-3034-3000-126-0": [{ type: "text", sub_type: "message", message: t("Front | Back") }],
		"s-3034-3000-127-0": [{ type: "text", sub_type: "message", message: t("Back") }],
		"s-3034-3000-128-0": [
		...
		"s-3034-3000-129-0": [{ type: "text", class_position: "tank", sub_type: "message", message: t("Dodge") }],
