...
module.exports = (dispatch, handlers, guide, lang, t) => {
	...
	return {
		...
		"s-782-1000-106-0": [{ type: "text", class_position: "tank", sub_type: "message", message: t("Heavy") }],
		"s-782-1000-107-0": [
		...
		"s-782-1000-109-0": [{ type: "text", sub_type: "message", message: t("Rocks (Small)") }],
		"s-782-1000-110-0": [{ type: "text", sub_type: "message", message: t("Rocks (Large)") }],
		"s-782-1000-111-0": [
			{ type: "text", sub_type: "message", message: t("Stun (Dodge)"), delay: 1500 },
			{ type: "spawn", func: "circle", args: [true, 553, 180, 50, null, 350, 1500, 2000] }
		],
		"s-782-1000-113-0": [{ type: "text", sub_type: "message", message: t("Thorns (Bleed)") }],
		"s-782-1000-116-0": [
		...
		"s-782-1000-307-0": [{ type: "text", sub_type: "message", message: t("Cage (Don't move)") }],
		// Flowers mech
		...
		"s-782-1000-201-0": [{ type: "text", sub_type: "alert", message: t("Change Debuff"), check_func: () => debuff !== 0 && color !== debuff, delay: 5000 }],
		"s-782-1000-309-0": [
		...
		"s-782-2000-105-0": [{ type: "text", sub_type: "message", message: t("Spin") }],
		"s-782-2000-108-0": [{ type: "text", sub_type: "message", message: t("Dodge. Shot Forward"), delay:  500 }],
		"s-782-2000-109-0": [{ type: "text", sub_type: "message", message: t("Wave Forward") }],
		"s-782-2000-112-0": [{ type: "text", sub_type: "message", message: t("Kick Forward") }],
		"s-782-2000-113-0": [
		...
		"s-782-2000-307-0": [{ type: "text", sub_type: "message", message: t("Target") }],
		"s-782-2000-307-2": [{ type: "text", sub_type: "message", message: t("Dodge") }],
		...
		"h-782-3000-80": [{ type: "text", sub_type: "message", message: t("80%"), check_func: () => !is_mt }],
		"h-782-3000-70": [{ type: "text", sub_type: "message", message: t("70%"), check_func: () => is_mt }],
		"s-782-3000-109-0": [{ type: "text", sub_type: "message", message: t("Front Throw (Target)") }],
		"s-782-3000-134-0": [{ type: "text", sub_type: "message", message: t("Front Throw (Target)") }],
		"s-782-3000-118-0": [{ type: "text", sub_type: "message", message: t("Front Triple") }],
		"s-782-3000-143-0": [
		...
		"s-782-3000-213-0": [{ type: "text", sub_type: "message", message: t("Tail") }],
		"s-782-3000-215-0": [{ type: "text", sub_type: "message", message: t("Tail (Combo)") }],
		"s-782-3000-139-0": [
			{ type: "text", sub_type: "message", message: t("Wave + Wing (Left Safe)"), check_func: () => print_wave },
		...
		"s-782-3000-141-0": [
			{ type: "text", sub_type: "message", message: t("Wave + Wing (Right Safe)"), check_func: () => print_wave },
			{ type: "despawn_all", tag: "wave" },
			{ type: "spawn", func: "vector", args: [912, 90, 0, 0, 600, 100, 3000], tag: "wave" },
			{ type: "spawn", func: "vector", args: [912, 270, 0, 180, 600, 100, 3000], tag: "wave" },
		...
		"s-782-3000-300-0": [
			...
			{ type: "text", sub_type: "message", delay: 1200, message: t("Dodge! (Awakening 1)") }
		], // <80%
		"s-782-3000-360-0": [{ type: "text", sub_type: "message", message: t("Dodge! (Explosion)") }],
		"s-782-3000-351-0": [
